  ...
  <div id="my-modal" class="modal">
    ...
    <div class="modal-header">
      ...
      <div class="modal-footer">
        ...
        <input type="submit" class="butt" name="upload" value="Dodaj post!" />
      </div>
    </div>
  </div>
  </form>
    ...
    <tbody>
        ...
        <tr>
            ...
            <form action="edit_post.php" method="post" >
                ...
                <button type="submit" name='edit_post_button' class="btn btn-success">Edytuj</button>
            </form>
            </td>
            <td> 
            <form action="edition.php" method="post" >
                <input type = 'hidden' name='delete_post' value="<?php echo $row['post_id']; ?>">
                <button type="submit" name= 'delete_post_button' class="btn btn-danger">Usuń</button>
            </form>
            </td>
